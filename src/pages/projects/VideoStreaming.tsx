    ...
    <div className="video-detail-page">
      ...
      <div className="video-detail-content">
        ...
        <div className="project-section">
          <h4 className="project-title"> Summary</h4>
        ...
        <div className="project-section">
          ...
          <div className="subsection">
            <p className="experience-text">
              The application follows a microservices, event-driven architecture with three primary
              pipelines: <strong>Upload</strong>, <strong>Processing</strong>, and
              <strong> AI Interaction</strong>. All components are serverless, ensuring automatic
        ...
        <div className="project-section upload-pipeline-section">
          <h4 className="project-title">Upload Pipeline</h4>
          <img src="/video-streaming-diagrams/uploadflow.svg" alt="Upload Pipeline Diagram" className="video-streaming-diagram" style={{ width: '100%', maxWidth: 600, margin: '0 auto', display: 'block' }} />
          <ul className="solutions-list" style={{ marginTop: '1rem' }}>
            ...
            <li>
              Cloud Function verifies authentication and generates a signed URL with: unique filename (<code>userId-timestamp-extension</code>), 15-minute expiration, write-only permissions, and 1GB file size limit
            </li>
        ...
        <div className="project-section transcription-pipeline-section">
          <h4 className="project-title">Video Transcription Pipeline</h4>
            <img src="/video-streaming-diagrams/videotranscription.svg" alt="Video Transcription Pipeline Diagram" className="video-streaming-diagram" style={{ width: '100%', maxWidth: 900, margin: '0 auto', display: 'block' }} />
          <ul className="solutions-list" style={{ marginTop: '1rem' }}>
